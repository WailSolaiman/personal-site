        ...
        <div className="uk-width-1-2 uk-width-1-3@m uk-width-1-2@xl">
            <div>
                ...
                <p className="uk-margin-remove-top">
                    Abschluss Informatik / Softwaretechnik (B.Eng.)
                </p>
            </div>
            <div>
                ...
                <ul
                    ...
                    <li className="uk-margin-remove">HTML5, CSS3 und SASS.</li>
                    ...
                    <li className="uk-margin-remove">
                        JS Frameworks: React, Gatsby und jQuery.
                    </li>
                    <li className="uk-margin-remove">
                    ...
                    <li className="uk-margin-remove">
                        Grundlagen der MERN Stack. (React - MongoDB - Express -
                        Node.js)
                    </li>
                    <li className="uk-margin-remove">
                        Node.js Modules: Express, Mongoose, Axios, Bcrypt, JWT
                        und Validator.js.
                    </li>
                    <li className="uk-margin-remove">Responsive Design.</li>
                    <li className="uk-margin-remove">
                        Umgehen mit der JavaScript-DOM.
                    </li>
                    <li className="uk-margin-remove">
                        Programmierung dynamischer Websites mit JavaScript.
                    </li>
                    <li className="uk-margin-remove">
                        Entwicklung von Web-Apps mit Hilfe des REST-Prinzips
                        sowie HTTP- und HTTPS-Protokolls.
                    </li>
                </ul>
            </div>
        </div>
